...
{
    public class OsvTourGuideEventComponent : EventComponent<OsvTourGuide>
    {
        private readonly EventsCollection EventsCollection;

        public OsvTourGuideEventComponent(OsvTourGuide entity) : base(entity)
        {
        ...
        private void HandleEvent(KnpEvent e)
        {
            ...
            if (Entity.State != OsvTourGuideState.Driving) return;
            ...
            if (remainingDistance > OsvTourGuide.InsertAnimalSightingDistanceAhead)
            {
                ...
                Entity.State = OsvTourGuideState.Braking;
