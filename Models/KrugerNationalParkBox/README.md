...
- `camp_waypoints.xls`: downloaded from [KNP website](https://www.sanparks.org/parks/kruger/conservation/scientific/maps/maps_infrastructure.php), coordinates and categories of camps. File seems old / not quite accurate. Lat/Lng of camps can be off a bit. We corrected some camp coordinates with information from Google Maps.
