...
namespace KrugerNationalParkTests
{
    public static class ResourcesConstants
    {
        ...
        public static readonly string FerryContainer =
            Path.Combine(VectorDataFolder, "gateway", "hamburg_container_terminals.geojson");
